...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      alert("Falha ao cliar o bolão, teste novamente!");
    }
  }
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center ">
      <main>
        ...
        <p className="mt-4 text-small text-gray-300 leading-relaxed">
      ...
      <Image
        src={appPreviewImg}
        alt="Dois celulares exibindo prévia da aplicação do NLW copa"
        quality={100}
      />
    </div>
  );
